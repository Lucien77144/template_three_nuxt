/**
 * regex_mobile1 and regex_mobile2 are used to detect mobile devices
 */
const REGEX_MOBILE1 =
...
/**
 * regex_mobile_or_tablet1 and regex_mobile_or_tablet2 are used to detect mobile or tablet devices
 */
